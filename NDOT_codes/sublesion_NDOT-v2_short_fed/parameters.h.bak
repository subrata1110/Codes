...
const double simu_time=5400*15; // total simulation time in sec
...
const string output_filename="all_ion_short_illie2012.csv";
const string output_remin_demin="Remin_demin_short_illie2012.csv";
