...
const string output_filename="all_ion_short_ca1p32_HighKhap_illie2012.csv";
const string output_remin_demin="Remin_demin_short_ca1p32_HighKhap_illie2012.csv";
