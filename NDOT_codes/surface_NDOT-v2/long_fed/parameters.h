...
const double simu_time=5400*1; // total simulation time in sec
...
const int n_fixed_ions=7; // number of fixed ions in plaque
const int nr_fixed=3; // number of reaction which are for fixed charges
...
const double t_rest=100.0, t_step=10.0, t_feed=1200.0 ;
const double t_gap=4190.0;
...
const string output_filename="all_ion_long_ca1p32_HighKhap_illie2012.csv";
const string output_remin_demin="Remin_demin_long_ca1p32_HighKhap_illie2012.csv";
